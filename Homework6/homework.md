...
### Ans
I ran this command: ```docker exec redpanda-1 rpk version```
Version got: ```v24.2.18```
...
### Ans
The command I used is ```docker exec redpanda-1 rpk topic create green-trips```. 
...
### Ans
I ran the code in Jupyter and the output of the last command is `True`.
...
### Ans
It took me 20.66 seconds to send the entire dataset and flush.
